...
ROOT = game_root()
SOURCE = content_path(ROOT, "assets/images/katchimeras/merge-world/generated/merge-board-base.webp")
DESIGN_OUT = (
    content_path(ROOT, "design/floating-neighborhood-v2/mossprout-garden-board")
    / "mossprout-garden-board-merge-overlay.png"
)
RUNTIME_OUT = (
    content_path(ROOT, "assets/images/katchimeras/world/hex")
    / "floating_neighborhood_v2_mossprout_garden_board_merge_overlay_512x768.webp"
)
BOARD_BASE_OUT = (
    content_path(ROOT, "assets/images/katchimeras/merge-world/generated")
...
def main() -> None:
    ...
    print(logical_path(ROOT, DESIGN_OUT))
    print(logical_path(ROOT, RUNTIME_OUT), f"{RUNTIME_OUT.stat().st_size // 1024} KB")
    print(logical_path(ROOT, BOARD_BASE_OUT), f"{BOARD_BASE_OUT.stat().st_size // 1024} KB")
