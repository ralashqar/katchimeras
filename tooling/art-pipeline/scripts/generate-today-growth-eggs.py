...
ROOT = game_root()
OUTPUT = content_path(ROOT, "assets/images/katchimeras/cutouts/growth-v2")
WORK = content_path(ROOT, "tmp/today-growth-v2-fal")
ENVIRONMENT_REF = content_path(ROOT, "assets/images/katchimeras/world/backgrounds/home/home-exploration-v1.png")
BARISTABBIT_REF = content_path(ROOT, "assets/images/katchimeras/evolution-grids/baristabbit-three-stage-medium-v3/cells/stage-03-adult.png")
...
def main() -> None:
    ...
    manifest: dict = {
        ...
        "styleReferences": [str(logical_path(ROOT, ENVIRONMENT_REF)), str(logical_path(ROOT, BARISTABBIT_REF))],
