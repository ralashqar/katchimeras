...
ROOT = game_root()
SOURCE_DIR = content_path(ROOT, "design") / "mossprout-garden-entry-v1"
RUNTIME_DIR = content_path(ROOT, "assets") / "images" / "katchimeras" / "world" / "square"
...
def package_asset(stem: str, source_name: str) -> None:
    ...
    for side, suffix in ((1024, ""), (512, "-512"), (256, "-256")):
        ...
        print(f"Wrote {logical_path(ROOT, output)} ({side}x{side})")
