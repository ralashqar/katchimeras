...
ROOT = game_root()
OUT = content_path(ROOT, "assets") / "images" / "katchimeras" / "quests" / "feastle-merge"
REFERENCE = content_path(ROOT, "assets") / "images" / "katchimeras" / "environments" / "feastle_hearth" / "base.png"
