...
ROOT = str(game_root())
DESIGN_DIR = str(content_path(ROOT, 'design', 'kingdom-sky'))
ASSET_DIR = str(content_path(ROOT, 'assets', 'images', 'katchimeras', 'world', 'sky'))
WORK_DIR = str(content_path(ROOT, '.tmp', 'kingdom-sky'))
