...
ROOT = game_root()
DEFAULT_MANIFEST = content_path(ROOT, "scripts") / "merge-world-item-art-manifest.json"
DEFAULT_OUT = content_path(ROOT, "assets") / "images" / "katchimeras" / "merge-world" / "items"
ALPHA_THRESHOLD = 18
