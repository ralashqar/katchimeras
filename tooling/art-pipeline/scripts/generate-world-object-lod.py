...
ROOT = game_root()
WORLD_VISUALS = content_path(ROOT, "utils") / "world-visuals.ts"
OBJECT_ROOT = content_path(ROOT, "assets") / "images" / "katchimeras" / "world" / "objects"
LOD_ROOT = content_path(ROOT, "assets") / "images" / "katchimeras" / "world" / "objects_lod"
MANIFEST = content_path(ROOT, "constants") / "world-asset-lod-sources.gen.ts"
