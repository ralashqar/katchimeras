...
ROOT = game_root()
DEFAULT_FULL = content_path(ROOT, "assets") / "images" / "katchimeras" / "merge-world" / "locked" / "dream-mist-full.webp"
DEFAULT_LOWER = content_path(ROOT, "assets") / "images" / "katchimeras" / "merge-world" / "locked" / "dream-mist-lower.webp"
SIZE = 192
HARD_LIMIT = 35 * 1024
