# Encora trophy generation prompts
...
- `assets/images/katchimeras/cutouts/encora.png`
- `assets/images/katchimeras/manual-journal/studio.webp`
- `assets/images/katchimeras/world/objects/body_studio/melody_chime.webp`

## Art set

Listening stations, music archives, soundwave crests, music satchels, and sound-garden portals.
...
- Exact production prompts are stored as `encora-v1-sheet-a-prompt.txt` and `encora-v1-sheet-b-prompt.txt`.
- fal request IDs, prompt hashes, references, and source URLs are stored in `tmp/imagegen/creativity-batch-v1/*.generation.json`.

Measured transparent grid cuts and runtime mappings are stored in `encora-v1.json`.
