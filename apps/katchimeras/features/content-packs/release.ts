...
export const CONTENT_KINDS = ['characters', 'families', 'skins', 'mergeChains', 'mergeGenerators', 'islands', 'storyTiles', 'hatchables', 'missions', 'chapters', 'conversations', 'flows', 'liveEvents'] as const satisfies readonly (keyof ContentPackContent)[];
