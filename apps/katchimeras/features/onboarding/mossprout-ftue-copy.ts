...
export const MOSSPROUT_FTUE_COPY = {
  ...
  seedOrigin: 'Five empty patches around Heartwood… and I kept the old spring’s seed safe. Let’s plant it beside the Tree. Everything here grew from that water.',
