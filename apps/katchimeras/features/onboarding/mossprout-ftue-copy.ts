...
export const MOSSPROUT_FTUE_COPY = {
  ...
  mistClearTitle: 'Something is under there. Merge to reach it.',
  mistClearBody: '',
  mistThins: 'The Mist lets go.',
  eggHeardYou: 'The Mist lets go.',
  ...
  seedOrigin: 'I kept the old spring’s seed. Plant it beside Heartwood.',
  bond: 'You found me. Now we can find the others. And perhaps stop my leaves rustling with excitement.',
  planted: 'There. Our Dew Spring, right beside Heartwood. Four patches still waiting. We’ll bring this whole circle back to life.',
  mergePurpose: 'The trail needs light. Let’s grow what our friends need and send it farther.',
  growth: 'Heartwood’s first root is glowing.',
  waterQuestion: 'Your turn. Look up from this for a moment.',
  farewell: 'Three notches on that marker. Steppling’s. I’ll rest and keep the roots bright. You needn’t wait for me.',
  ...
  meditationHelp: 'Find Steppling at the broken trail.',
...
export const MOSSPROUT_GREETING_OPTIONS = [
  { id: 'hello', label: '🌳 What happened here?', reply: 'The Mist cut Heartwood off. Its roots are hungry. This Garden feeds the first one.' },
  { id: 'garden', label: '🏮 Can we light it again?', reply: 'I think so. One Garden first, then the paths between our homes.' },
  { id: 'tiny', label: '🥾 Where do we start?', reply: 'This Garden. I packed a seed for Heartwood. Less fortunately, I ate the map.' },
] as const;
