...
const cardSource = readVerificationSource(
  contentPath(projectRoot, 'components/katchadeck/cards/daily-card.tsx'),
  'utf8'
);
const viewerSource = readVerificationSource(
  contentPath(projectRoot, 'components/katchadeck/cards/daily-card-viewer.tsx'),
  'utf8'
);
