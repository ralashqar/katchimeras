...
const stripSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/home/day-prompt-strip.tsx'), 'utf8');
const momentSheetSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/home/moment-prompt-sheet.tsx'), 'utf8');
...
const actionStackSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/world/world-action-stack.tsx'), 'utf8');
check('Add button does not pass press event as prompt', actionStackSource.includes('onPress={() => onAdd()}'));
const promptControllerSource = readVerificationSource(contentPath(projectRoot, 'features/today/use-prompt-sheet-controller.ts'), 'utf8');
...
const todaySheetHostSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/home/today-sheet-host.tsx'), 'utf8');
...
const todaySource = readVerificationSource(contentPath(projectRoot, 'app/(tabs)/today.tsx'), 'utf8');
const inlineVoiceSource = readVerificationSource(contentPath(projectRoot, 'hooks/use-inline-voice-note.ts'), 'utf8');
const inlineVoiceUiSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/world/inline-voice-note.tsx'), 'utf8');
const noteInterpretSource = readVerificationSource(contentPath(projectRoot, 'utils/note-interpret.ts'), 'utf8');
const quickNoteSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/home/quick-note-composer.tsx'), 'utf8');
const noteCaptureControllerSource = readVerificationSource(contentPath(projectRoot, 'features/today/use-note-capture-controller.ts'), 'utf8');
const hatchCheckInSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/home/hatch-check-in-sheet.tsx'), 'utf8');
const todayBottomDockSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/home/today-bottom-dock.tsx'), 'utf8');
const hatchCheckInPlannerSource = readVerificationSource(contentPath(projectRoot, 'utils/hatch-check-in.ts'), 'utf8');
const hatchControllerSource = readVerificationSource(contentPath(projectRoot, 'features/today/use-hatch-controller.ts'), 'utf8');
const mapPhotoRefreshSource = readVerificationSource(contentPath(projectRoot, 'hooks/use-day-map-photo-refresh.ts'), 'utf8');
const allDaysSource = readVerificationSource(contentPath(projectRoot, 'hooks/use-all-days.ts'), 'utf8');
const hatchingSource = readVerificationSource(contentPath(projectRoot, 'game/days/hatching.ts'), 'utf8');
const homeStorageSource = readVerificationSource(contentPath(projectRoot, 'utils/home-storage.ts'), 'utf8');
const hatchIntegritySource = readVerificationSource(contentPath(projectRoot, 'game/days/state-integrity.ts'), 'utf8');
const exploreSource = readVerificationSource(contentPath(projectRoot, 'app/(tabs)/explore.tsx'), 'utf8');
const momentCaptureSource = readVerificationSource(contentPath(projectRoot, 'app/moment-capture.tsx'), 'utf8');
...
const actionRouterSource = readVerificationSource(contentPath(projectRoot, 'features/today/use-today-action-router.ts'), 'utf8');
const dayJournalSectionsSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/home/day-journal-sections.tsx'), 'utf8');
const todayCategoryRingSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/home/today-category-ring.tsx'), 'utf8');
...
const dayMapRouteSource = readVerificationSource(contentPath(projectRoot, 'app/day-map/[dayId].tsx'), 'utf8');
const dayMapSurfaceSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/day-map/day-map-surface.tsx'), 'utf8');
const dayMapHeaderSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/day-map/day-map-header.tsx'), 'utf8');
const dayMapDockSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/day-map/day-map-bottom-dock.tsx'), 'utf8');
const dayMapPlaceSheetSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/day-map/day-map-place-sheet.tsx'), 'utf8');
const photoEssenceRouteSource = readVerificationSource(contentPath(projectRoot, 'app/photo-essence.tsx'), 'utf8');
const dayActionsSource = readVerificationSource(contentPath(projectRoot, 'game/days/actions.ts'), 'utf8');
...
const manualJournalSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/home/manual-journal-sheet.tsx'), 'utf8');
const katchaSheetSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/ui/katcha-sheet.tsx'), 'utf8');
...
const essenceReviewSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/capture/essence-review.tsx'), 'utf8');
const photoJournalAnalysisSource = readVerificationSource(contentPath(projectRoot, 'utils/photo-journal-analysis.ts'), 'utf8');
const photoJournalCommitSource = readVerificationSource(contentPath(projectRoot, 'utils/intelligence/photo-journal-commit.ts'), 'utf8');
...
const foodSheetSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/world/food-vault-sheet.tsx'), 'utf8');
...
const placeSheetSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/world/place-prompt-sheet.tsx'), 'utf8');
const lifeEventSheetSource = readVerificationSource(contentPath(projectRoot, 'components/katchadeck/world/big-moment-picker-sheet.tsx'), 'utf8');
