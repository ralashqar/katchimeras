...
fs.copyFileSync(contentPath(projectRoot, 'data/world-structure-layout.json'), path.join(tempDir, 'world-structure-layout.json'));
fs.copyFileSync(contentPath(projectRoot, 'data/world-tile-layout.json'), path.join(tempDir, 'world-tile-layout.json'));
...
const assetsRoot = contentPath(projectRoot, 'assets', 'images', 'katchimeras', 'world');
