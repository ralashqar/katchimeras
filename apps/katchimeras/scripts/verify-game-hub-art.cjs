...
const manifest = JSON.parse(readVerificationSource(contentPath(root, 'data', 'game-hub-art.json'), 'utf8'));
const generator = readVerificationSource(contentPath(root, 'scripts', 'generate-game-hub-art.py'), 'utf8');
const hub = readVerificationSource(contentPath(root, 'components', 'katchadeck', 'games', 'game-hub-screen.tsx'), 'utf8');
