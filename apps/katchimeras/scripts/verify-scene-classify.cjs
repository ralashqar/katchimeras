...
const sceneSource = readVerificationSource(contentPath(projectRoot, 'utils/scene-classify.ts'), 'utf8');
const foundationSource = readVerificationSource(contentPath(projectRoot, 'utils/foundation-scene.ts'), 'utf8');
