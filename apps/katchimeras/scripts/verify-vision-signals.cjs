...
const nativeVisionSource = readVerificationSource(
  contentPath(projectRoot, 'modules/katchimera-vision/ios/KatchimeraVisionModule.swift'),
  'utf8'
);
const essenceReviewSource = readVerificationSource(
  contentPath(projectRoot, 'components/katchadeck/capture/essence-review.tsx'),
  'utf8'
);
const photoAnalysisSessionSource = readVerificationSource(
  contentPath(projectRoot, 'hooks/use-photo-analysis-session.ts'),
  'utf8'
);
const foundationSource = readVerificationSource(
  contentPath(projectRoot, 'modules/katchimera-foundation/ios/KatchimeraFoundationModule.swift'),
  'utf8'
);
