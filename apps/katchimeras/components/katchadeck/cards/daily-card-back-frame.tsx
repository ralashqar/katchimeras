...
const backFrameArt = require('@incubator/art-cards/daily-card-back-frame.png');
const backWatermarkArt = require('@incubator/art-cards/daily-card-back-watermark.png');
