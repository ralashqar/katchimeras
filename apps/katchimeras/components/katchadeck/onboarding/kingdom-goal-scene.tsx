...
export const KINGDOM_GOAL_LINE = 'Every place we bring back brings a friend home. Let’s start with the one waiting beyond the mist.';
export const KINGDOM_GOAL_PREMISE = 'This garden used to be full of friends. When the mist came, they drifted into it, one by one. Every place we bring back helps one of them find the way home.';
export const KINGDOM_GOAL_ACTION = 'Find the first friend';
