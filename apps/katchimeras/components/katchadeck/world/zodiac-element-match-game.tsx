...
const GEM_SOURCES: Record<string, number> = {
  'fire-ruby': require('@incubator/art-zodiac/gems/fire-ruby.png'),
  'fire-sunstone': require('@incubator/art-zodiac/gems/fire-sunstone.png'),
  'earth-emerald': require('@incubator/art-zodiac/gems/earth-emerald.png'),
  'earth-jade': require('@incubator/art-zodiac/gems/earth-jade.png'),
  'air-opal': require('@incubator/art-zodiac/gems/air-opal.png'),
  'air-celestite': require('@incubator/art-zodiac/gems/air-celestite.png'),
  'water-sapphire': require('@incubator/art-zodiac/gems/water-sapphire.png'),
  'water-aquamarine': require('@incubator/art-zodiac/gems/water-aquamarine.png'),
};
