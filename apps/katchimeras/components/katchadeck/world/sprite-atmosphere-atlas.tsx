...
const PARTICLE_ATLAS = require('@incubator/art-atmosphere/particle-atlas-v1.png');
const JOURNEY_BREEZE_ATLAS = require('@incubator/art-atmosphere/journey-breeze-atlas-v1.webp');
const DREAM_WISPS_ATLAS = require('@incubator/art-atmosphere/dream-wisps-atlas-v2.png');
const SOCIAL_RIBBONS_ATLAS = require('@incubator/art-atmosphere/social-ribbons-atlas-v1.png');
