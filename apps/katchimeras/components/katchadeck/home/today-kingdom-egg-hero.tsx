...
const DISCOVERY_SOFT_GLOW = require('@incubator/art-characters/soft-glow.png');
const DISCOVERY_CRACK_ONE = require('@incubator/art-egg-avatars/effects/crack-1.png');
const DISCOVERY_CRACK_TWO = require('@incubator/art-egg-avatars/effects/crack-2.png');
...
const SOFT_RING_SOURCE = require('@incubator/art-characters/soft-ring.png');
