...
const CLOUDS = {
  far: require('@incubator/art-world/sky/kingdom-cloud-far-bank-512.webp'),
  middle: require('@incubator/art-world/sky/kingdom-cloud-mid-wide-512.webp'),
  tall: require('@incubator/art-world/sky/kingdom-cloud-mid-tall-512.webp'),
  near: require('@incubator/art-world/sky/kingdom-cloud-near-bank-1024.webp'),
} as const;
