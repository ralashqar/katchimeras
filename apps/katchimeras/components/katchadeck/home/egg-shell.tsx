...
const eggCrackOne = require('@incubator/art-egg-avatars/effects/crack-1.webp');
const eggCrackTwo = require('@incubator/art-egg-avatars/effects/crack-2.webp');
const eggCrackOneHighResolution = require('@incubator/art-egg-avatars/effects/crack-1.png');
const eggCrackTwoHighResolution = require('@incubator/art-egg-avatars/effects/crack-2.png');
