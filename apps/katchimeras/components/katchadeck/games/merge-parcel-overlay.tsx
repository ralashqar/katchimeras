...
const PARCEL_ART = require('@incubator/art-world/objects_lod/gift_crate/gift_crate_pick__medium.webp');
const PARCEL_TRAY_ART = require('@incubator/art-merge-world/ui/order-service-tray.webp');
