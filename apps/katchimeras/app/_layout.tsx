...
function RootLayout() {
  ...
  const [fontsLoaded] = useFonts({
    ...
    InstrumentSerif: require('@incubator/art-fonts/InstrumentSerif-Regular.ttf'),
    Manrope: require('@incubator/art-fonts/Manrope-Variable.ttf'),
  });
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      ...
      <ThemeProvider value={navigationTheme}>
        <GameUIProvider>
          ...
          <Stack.Screen name="dev-world-board-lab" options={{ title: 'World + Board Lab', headerShown: false }} />
