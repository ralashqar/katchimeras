...
export const FERNIP_WILDGROWTH_CAMPAIGN: IslandCampaignDefinition<FernipRestStyle> = {
  ...
  chapters: [
    {
      ...
      prompt: 'The moss here wandered outside its patch years ago and never went back. Then the Mist came down over it, and the moss stopped, mid-wander. Three Mistwisps are sitting on it now, being very still, as if that counts as resting. I found it by lying down in it, which is my preferred way of finding most things.\n\nWhen you finally stop for the day, what do you reach for first?',
      ...
      choices: [
        {
          ...
          openingConclusion: 'Then we begin with one plant and no plan for it. The Mist can come off this patch slowly. Make a little light and watch it flinch.',
          ...
          resolutionLine: 'The moss spread exactly as far as it felt like. The Mist never got the hang of that pace. It seems to work.',
        },
        {
          ...
          openingConclusion: 'One plant, planted slightly wrong on purpose. The Mist has no idea what to do with that. Let’s clear it a patch to lean in.',
          returnLine: 'It leans. I love it. Set it in the Mist and see what the moss makes of it. This first bit is my gift.',
      ...
      choices: [
        {
          ...
          openingConclusion: 'Then we make the hollow soft enough that silence feels like a choice, not a gap. Four Mistwisps have the log. They are the wrong kind of quiet.',
        ...
        },
        {
          ...
          openingConclusion: 'We will give the hollow a little something to play at. Four Mistwisps are sitting on at least three mushrooms I have not counted.',
        ...
        },
        {
          ...
          openingConclusion: 'We will clear the hollow with a way out that is always visible. Four Mistwisps have the door. Let’s start where they are thinnest.',
    ...
    },
    {
      ...
      prompt: 'I spent three days tidying the ferns into neat rows so the grove would look restful. It looked like a waiting room. The vines undid all of it overnight, and the Mist settled back over the mess, four Mistwisps deep, as if to say: leave it. The vines were right. The Mist was not, but it does a very good impression.\n\nWhen rest starts to feel like another job, what helps you let go?',
      ...
      choices: [
        {
          ...
          openingConclusion: 'We will grow two things and then keep our hands in our pockets. The vines can decide what stays tangled. The Mist does not get a vote.',
          returnLine: 'A rare flower and a boot, and I have not touched either of them. Set them in the thicket and the Mist will let go of the rest.',
        ...
        },
        {
          ...
          openingConclusion: 'Then we make it gloriously overgrown. Let’s see what the Mist has been keeping in there.',
        ...
        },
        {
          ...
          returnLine: 'Everything is here, and it is fine. Actually fine. Set them down and the Mist will have to believe it too.',
    ...
    },
    {
      ...
      prompt: 'Even the mushrooms are glowing now, and the last of the Mist flinches every time they do. I think they heard there was room here to be themselves. I never planned for glowing mushrooms; I just stopped telling things what to be.\n\nWhat would you want to remember about rest, from here on?',
      ...
      choices: [
        {
          ...
          openingConclusion: 'We finish slowly, then. One plant, one pack, all the time they need. Four Mistwisps have the last corner, and they are in no hurry either. We will see who is more patient.',
          returnLine: 'A magical plant and a pack for the trail, gathered without hurry. Set them down and the last of the Mist can go the way the rest went.',
        ...
        },
        {
          ...
          openingConclusion: 'One last silly, glorious task. Four Mistwisps are sitting on the last corner, being serious at it. Let’s ruin that.',
          returnLine: 'The pieces are here and one of them is already glowing. Put them in and the last of the Mist can leave the ridiculous to us.',
        ...
        },
        {
          ...
          openingConclusion: 'We finish by clearing somewhere it is safe to stop. Four Mistwisps have kept that corner for last. They would.',
  ...
  payoff: {
    ...
    closingLine: 'The grove will keep glowing. Once a place has been looked at properly, the Mist cannot get it back. Rest is like that too.',
    insights: {
      unhurried: {
  ...
  copy: {
    discoveryDialogue: 'Oh. Hello. I was resting under the ferns, and then someone looked this way and the Mist went thin. Everything here is tangled and I would like to keep it that way, but the Mist has it all held down. Help me lift it, a patch at a time?',
    discoveryActionLabel: 'Talk with Fernip',
    revealReactionLine: 'The Mist drifts off a tangled grove. Something under the ferns stretches.',
    ...
    speech: {
      available: ({ coins, cost }) => cost <= 0
        ? 'The moss is under the Mist somewhere. No hurry.'
        : coins >= cost
          ? 'The moss is under the Mist somewhere. Whenever you feel like it.'
          : `${coins} of ${cost} Glow so far. The ferns are in no rush.`,
      delivery_requested: () => 'This patch has done all it is going to. What the Mist still keeps is waiting on your board.',
    ...
    fallbackResolution: (level) => level === 4
      ? 'The whole wild corner is glowing, and the Mist has nothing left to hold. I did not tidy a single thing.'
      : 'The grove grew a little wilder, and a little more like home.',
    wakeHandoffLine: 'Resting is not the same as being forgotten. The Mist would like you to confuse the two. I did, for a while. Past the ferns there is a nursery where someone keeps counting seeds. I think they would like company.',
    ...
    wispLines: {
      ...
      fell: ['One gone. The moss noticed.', 'Another gone. No hurry.', 'One left, and it looks tired.'],
