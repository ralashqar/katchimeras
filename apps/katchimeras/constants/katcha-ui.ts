...
export const KatchaUI = {
  ...
  companionScenePanel: {
    background: 'rgba(35,45,35,0.92)',
    border: 'rgba(236,211,143,0.34)',
    shadow: '0 16px 36px rgba(13,24,17,0.38), inset 0 1px 0 rgba(255,255,255,0.11)',
    cardBackground: 'rgba(25,35,28,0.82)',
    cardBorder: 'rgba(255,255,255,0.12)',
    cardSelected: 'rgba(73,83,52,0.96)',
    softBackground: 'rgba(255,255,255,0.07)',
    softBorder: 'rgba(244,224,170,0.15)',
    ink: '#FFF8E7',
    inkSoft: '#D7D9C7',
    inkMuted: '#AEB9A8',
      accent: '#F2C557',
      accentPressed: '#DDAF43',
      accentInk: '#493116',
      optionBackground: '#FFF3D3',
      optionBackgroundSelected: '#F5D985',
      optionBorder: 'rgba(242,197,87,0.5)',
      optionInk: '#3D2D1C',
      optionIcon: '#725127',
    },
  type: {
