...
export const LANTERN_RECURRING_ORDERS = 20;
export const LANTERN_LEVELS = [
  { level: 1, name: 'First Light', orders: 0, residents: 3, benefit: 'A daily pack and three resident Wisps.' },
  { level: 2, name: 'Gathering', orders: 10, residents: 4, benefit: 'A bonus pack every 20 Garden orders. Room for four Wisps.' },
  { level: 3, name: 'Brighter Light', orders: 40, residents: 5, benefit: 'Every bonus pack guarantees a Rare or better. Room for five Wisps.' },
] as const;
