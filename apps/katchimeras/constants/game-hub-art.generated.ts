...
export const GAME_HUB_ART_SOURCES: Readonly<Record<string, number>> = {
  'quest-tasklet-desk-jam': require('@incubator/art-game-hub/tasklet-desk-jam.webp'),
  'quest-cheerlet-block-party': require('@incubator/art-game-hub/cheerlet-block-party.webp'),
};
