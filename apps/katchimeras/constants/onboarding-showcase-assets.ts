...
export const onboardingShowcaseAssets = {
  onboarding_run_voltstep: {
    ...
    source: require('@incubator/art-app-icons/onboarding-showcase/voltstep.webp'),
    sourceImageUrl:
  ...
  onboarding_home_hearthsip: {
    ...
    source: require('@incubator/art-app-icons/onboarding-showcase/hearthsip.webp'),
    sourceImageUrl:
  ...
  onboarding_museum_glimmuse: {
    ...
    source: require('@incubator/art-app-icons/onboarding-showcase/glimmuse.webp'),
    sourceImageUrl:
  ...
  onboarding_landmark_skysette: {
    ...
    source: require('@incubator/art-app-icons/onboarding-showcase/skysette.webp'),
    sourceImageUrl:
  ...
  onboarding_today_cremalume: {
    ...
    source: require('@incubator/art-app-icons/onboarding-showcase/creamalume.webp'),
    sourceImageUrl:
