...
export const heroOrbitAssets = {
  hoodedKatcher: require('@incubator/art-app-icons/onboarding-hero/hooded-katcher.webp'),
  mossprout: require('@incubator/art-app-icons/onboarding-hero/mossprout.webp'),
  lattelet: require('@incubator/art-app-icons/onboarding-hero/lattelet.webp'),
  ...
  crumbun: require('@incubator/art-app-icons/onboarding-hero/crumbun.webp'),
  hayhorn: require('@incubator/art-app-icons/onboarding-hero/hayhorn.webp'),
