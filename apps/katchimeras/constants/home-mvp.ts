...
> = {
  ...
  kindling: {
    source: require('@incubator/art-cutouts/kindling.png'),
    accentColor: '#E89A4D',
  },
  voltstep: {
    source: require('@incubator/art-cutouts/voltstep.png'),
    accentColor: '#93C7FF',
  },
  hearthsip: {
    source: require('@incubator/art-cutouts/hearthsip.png'),
    accentColor: '#F3B788',
  },
  glimmuse: {
    source: require('@incubator/art-cutouts/glimmuse.png'),
    accentColor: '#D5C4FF',
  },
  skysette: {
    source: require('@incubator/art-cutouts/skysette.webp'),
    accentColor: '#A9D7FF',
  },
  creamalume: {
    source: require('@incubator/art-cutouts/creamalume.png'),
    accentColor: '#F3B788',
  },
  pulsepounce: {
    source: require('@incubator/art-cutouts/hayhorn.webp'),
    accentColor: '#AEB6FF',
  },
  gatherglow: {
    source: require('@incubator/art-cutouts/gatherglow.png'),
    accentColor: '#F5C98F',
  },
  mossprout: {
    source: require('@incubator/art-cutouts/mossprout.png'),
    accentColor: '#8FD8BE',
  },
  lattelet: {
    source: require('@incubator/art-cutouts/lattelet.png'),
    accentColor: '#F3B788',
  },
  sprintail: {
    source: require('@incubator/art-cutouts/sprintail.png'),
    accentColor: '#FF8F5A',
  },
  neonpoko: {
    source: require('@incubator/art-cutouts/neonpoko.png'),
    accentColor: '#C77DFF',
  },
  crumbun: {
    source: require('@incubator/art-cutouts/crumbun.png'),
    accentColor: '#F2C2A8',
  },
  hayhorn: {
    source: require('@incubator/art-cutouts/hayhorn.webp'),
  ...
  ironette: {
    source: require('@incubator/art-cutouts/ironette.png'),
    accentColor: '#E7CDA0',
  },
  bedrotte: {
    source: require('@incubator/art-cutouts/bedrotte.png'),
    accentColor: '#F0C9A0',
  },
  steppling: {
    source: require('@incubator/art-cutouts/steppling.png'),
    accentColor: '#92D7FF',
  },
  promenip: {
    source: require('@incubator/art-cutouts/promenip.png'),
    accentColor: '#D98778',
  },
  metrostep: {
    source: require('@incubator/art-cutouts/metrostep.png'),
    accentColor: '#6489BA',
  },
  wanderling: {
    source: require('@incubator/art-cutouts/wanderling.png'),
    accentColor: '#8FA64D',
  },
  dashkit: {
    source: require('@incubator/art-cutouts/dashkit.png'),
    accentColor: '#398FE7',
  },
  enduroo: {
    source: require('@incubator/art-cutouts/enduroo.png'),
    accentColor: '#279A91',
  },
  trekkin: {
    source: require('@incubator/art-cutouts/trekkin.png'),
    accentColor: '#A87949',
  },
  treadlet: {
    source: require('@incubator/art-cutouts/treadlet.png'),
    accentColor: '#67C7A9',
  },
  errandimp: {
    source: require('@incubator/art-cutouts/errandimp.webp'),
    accentColor: '#EF9F6E',
  },
  quietome: {
    source: require('@incubator/art-cutouts/quietome.png'),
    accentColor: '#E0C18F',
  },
  relicoon: {
    source: require('@incubator/art-cutouts/relicoon.png'),
    accentColor: '#D98C6B',
  },
  shellio: {
    source: require('@incubator/art-cutouts/shellio.png'),
    accentColor: '#9FE0CB',
  },
  flickerbun: {
    source: require('@incubator/art-cutouts/flickerbun.png'),
    accentColor: '#B89CE8',
  },
  baristabbit: {
    source: require('@incubator/art-cutouts/baristabbit.png'),
    accentColor: '#E3B68C',
  },
  waglet: {
    source: require('@incubator/art-cutouts/waglet.png'),
    accentColor: '#E8975A',
  },
  whiskit: {
    source: require('@incubator/art-cutouts/whiskit.png'),
    accentColor: '#E0A878',
  },
  snuglet: {
    source: require('@incubator/art-cutouts/snuglet.png'),
    accentColor: '#EFB58D',
  },
  nestkin: {
    source: require('@incubator/art-cutouts/nestkin.png'),
    accentColor: '#9CBCC5',
  },
  driftkin: {
    source: require('@incubator/art-cutouts/driftkin.png'),
    accentColor: '#AFC9E6',
  },
  duskle: {
    source: require('@incubator/art-cutouts/duskle.png'),
    accentColor: '#F0A94E',
  },
  crustling: {
    source: require('@incubator/art-cutouts/crustling.webp'),
    accentColor: '#E6A862',
  },
  nigirimp: {
    source: require('@incubator/art-cutouts/nigirimp.png'),
    accentColor: '#F0A890',
  },
  noodloo: {
    source: require('@incubator/art-cutouts/noodloo.png'),
    accentColor: '#E6B070',
  },
  sundael: {
    source: require('@incubator/art-cutouts/sundael.png'),
    accentColor: '#F2C7CE',
  },
  bobaloo: {
    source: require('@incubator/art-cutouts/bobaloo.png'),
    accentColor: '#C9A06E',
  },
  dripkin: {
    source: require('@incubator/art-cutouts/dripkin.png'),
    accentColor: '#B88354',
  },
  matchamallow: {
    source: require('@incubator/art-cutouts/matchamallow.png'),
    accentColor: '#86B46A',
  },
  chaihare: {
    source: require('@incubator/art-cutouts/chaihare.png'),
    accentColor: '#E08345',
  },
  cocoabun: {
    source: require('@incubator/art-cutouts/cocoabun.png'),
    accentColor: '#8B5743',
  },
  frostaflop: {
    source: require('@incubator/art-cutouts/frostaflop.png'),
    accentColor: '#9EDBE3',
  },
  infusprig: {
    source: require('@incubator/art-cutouts/infusprig.png'),
    accentColor: '#A8C793',
  },
  zestlet: {
    source: require('@incubator/art-cutouts/zestlet.png'),
    accentColor: '#F5A447',
  },
  pagelet: {
    source: require('@incubator/art-cutouts/pagelet.webp'),
    accentColor: '#E2C49A',
  },
  hooplet: {
    source: require('@incubator/art-cutouts/hooplet.png'),
    accentColor: '#E8893F',
  },
  serveling: {
    source: require('@incubator/art-cutouts/serveling.png'),
    accentColor: '#CDE05A',
  },
  petalimp: {
    source: require('@incubator/art-cutouts/petalimp.png'),
    accentColor: '#9FD08A',
  },
  fernip: {
    source: require('@incubator/art-cutouts/fernip.png'),
    accentColor: '#8FBF7A',
  },
  drizzlet: {
    source: require('@incubator/art-cutouts/drizzlet.png'),
    accentColor: '#9FB8D0',
  },
  amberleaf: {
    source: require('@incubator/art-cutouts/amberleaf.png'),
    accentColor: '#E0853C',
  },
  blossle: {
    source: require('@incubator/art-cutouts/blossle.png'),
    accentColor: '#F2B6CC',
  },
  peakle: {
    source: require('@incubator/art-cutouts/peakle.png'),
    accentColor: '#9FB4C9',
  },
  stillo: {
    source: require('@incubator/art-cutouts/stillo.png'),
    accentColor: '#86C4CC',
  },
  twinklet: {
    source: require('@incubator/art-cutouts/twinklet.png'),
    accentColor: '#8C9BE0',
  },
  feastle: {
    source: require('@incubator/art-cutouts/feastle.png'),
    accentColor: '#E8A85C',
  },
  museling: {
    source: require('@incubator/art-cutouts/museling.png'),
    accentColor: '#C58AE0',
  },
  tasklet: {
    source: require('@incubator/art-cutouts/tasklet.png'),
    accentColor: '#7FA8E0',
  },
  cheerlet: {
    source: require('@incubator/art-cutouts/cheerlet.png'),
    accentColor: '#F29AC0',
  },
  voyagle: {
    source: require('@incubator/art-cutouts/voyagle.png'),
    accentColor: '#6FC4C0',
  },
  skylo: {
    source: require('@incubator/art-cutouts/skylo.png'),
    accentColor: '#9AAFC9',
  },
  flexel: {
    source: require('@incubator/art-cutouts/flexel.png'),
    accentColor: '#EE8A4A',
  },
  kickit: {
    source: require('@incubator/art-cutouts/kickit.png'),
    accentColor: '#6E93D6',
  },
  sluggeroo: {
    source: require('@incubator/art-cutouts/sluggeroo.png'),
    accentColor: '#6078A8',
  },
  scrumple: {
    source: require('@incubator/art-cutouts/scrumple.png'),
    accentColor: '#A54E5F',
  },
  ironel: {
    source: require('@incubator/art-cutouts/ironel.png'),
    accentColor: '#71808A',
  },
  tumblet: {
    source: require('@incubator/art-cutouts/tumblet.png'),
    accentColor: '#D58AAA',
  },
  pedalop: {
    source: require('@incubator/art-cutouts/pedalop.png'),
    accentColor: '#42B9BD',
  },
  dojoko: {
    source: require('@incubator/art-cutouts/dojoko.png'),
    accentColor: '#D45D59',
  },
  volleyhop: {
    source: require('@incubator/art-cutouts/volleyhop.png'),
    accentColor: '#F18A62',
  },
  flowlet: {
    source: require('@incubator/art-cutouts/flowlet.png'),
    accentColor: '#B7A4D8',
  },
  // Wave D flagships (real renders).
  mendle: {
    source: require('@incubator/art-cutouts/mendle.png'),
    accentColor: '#F0B49A',
  },
  pixooka: {
    source: require('@incubator/art-cutouts/pixooka.png'),
    accentColor: '#8C9BE8',
  },
  snoozle: {
    source: require('@incubator/art-cutouts/snoozle.png'),
    accentColor: '#BFC9E8',
  },
  encora: {
    source: require('@incubator/art-cutouts/encora.png'),
    accentColor: '#7FD8C4',
  },
  vesperitt: {
    source: require('@incubator/art-cutouts/vesperitt.png'),
    accentColor: '#6E7BC4',
  },
  dawnle: {
    source: require('@incubator/art-cutouts/dawnle.png'),
    accentColor: '#F4B48E',
  },
  tempesto: {
    source: require('@incubator/art-cutouts/tempesto.png'),
    accentColor: '#9AB0CE',
  },
  mistle: {
    source: require('@incubator/art-cutouts/mistle.png'),
    accentColor: '#C2CCD8',
  },
};
