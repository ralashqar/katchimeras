...
const SHARED_TECH = [
  ...
  'features/mission-mechanics/board-window.ts',
  'features/mission-mechanics/column-shot.ts',
  'features/mission-mechanics/glow-strikes.ts',
  'features/mission-mechanics/mechanic.ts',
  'features/mission-mechanics/preview.ts',
  'features/mission-mechanics/wisp-target.ts',
  'features/onboarding/hatchable-flows.ts',
  'features/onboarding/hatchable-runtime.ts',
  'features/onboarding/use-mist-mission.ts',
  'types/mission-mechanic.ts',
