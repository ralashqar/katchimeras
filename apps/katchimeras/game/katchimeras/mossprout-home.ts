...
const MOSSPROUT_CONVERSATION_ART: Readonly<Record<string, KatchimeraActionArtKey>> = {
  'mossprout:conversation:nature-question:week-garden': 'mossprout:garden-rules',
  'mossprout:conversation:nature-question:free-time': 'mossprout:outdoor-luxury',
  'mossprout:conversation:nature-question:most-trouble': 'mossprout:plant-care',
  'mossprout:conversation:nature-question:make-easier': 'mossprout:nature-light',
  'mossprout:conversation:nature-question:huge-thing': 'mossprout:journey',
  'mossprout:conversation:nature-question:unkillable-plant': 'mossprout:plant-care',
  'mossprout:conversation:nature-question:best-progress': 'mossprout:nature-observation',
  'mossprout:conversation:nature-question:rough-day-support': 'mossprout:garden-guest',
  'mossprout:conversation:nature-question:more-dangerous': 'mossprout:nature-weather',
  'mossprout:conversation:nature-question:tiny-weed': 'mossprout:garden-rules',
  'mossprout:conversation:nature-question:when-wrong': 'mossprout:nature-weather',
  'mossprout:conversation:nature-question:bad-at-it': 'mossprout:journey',
  'mossprout:conversation:nature-question:rather': 'mossprout:nature-card',
  'mossprout:conversation:nature-question:secret-compliment': 'mossprout:garden-guest',
  'mossprout:conversation:nature-question:little-door': 'mossprout:suspicious-path',
  'mossprout:conversation:nature-question:disappears-first': 'mossprout:nature-window',
  'mossprout:conversation:nature-question:success': 'mossprout:nature-light',
  'mossprout:conversation:nature-question:avoiding': 'mossprout:plant-care',
  'mossprout:conversation:nature-question:unnoticed-progress': 'mossprout:nature-observation',
  'mossprout:conversation:nature-question:satisfying-day': 'mossprout:outdoor-luxury',
  'mossprout:conversation:nature-question:stop-one-thing': 'mossprout:cloud-job',
  'mossprout:conversation:nature-question:magic-plot': 'mossprout:garden-rules',
  'mossprout:conversation:nature-question:lose-motivation': 'mossprout:journey',
  'mossprout:conversation:nature-question:scares-more': 'mossprout:nature-weather',
  'mossprout:conversation:nature-question:today-needs': 'mossprout:nature-light',
  'mossprout:conversation:nature-question:good-day': 'mossprout:nature-sound-map',
    ...
    primaryLabel: !input.journey
      ...
      : status === 'opening'
        ...
        : status === 'profile_available'
          ? 'Find your closest garden resident'
          : status === 'resident_discovery'
            ? 'Open the resident parcel'
            : status === 'resident_orders'
              ? 'Help the new resident'
              : status === 'card_reward'
                ? 'Reveal the resident card'
          : status === 'living'
