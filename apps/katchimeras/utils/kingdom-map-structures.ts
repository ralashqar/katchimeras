...
export const MOSSPROUT_GARDEN_BOARD: KingdomMapStructureDefinition = {
  ...
  art: {
    revealed: {
      source: require('@incubator/art-world/hex/floating_neighborhood_v2_mossprout_garden_board_512x768.webp'),
    ...
    locked: {
      source: require('@incubator/art-world/hex/floating_neighborhood_v2_mossprout_garden_board_locked_512x768.webp'),
      sourceSize: GARDEN_SOURCE_SIZE,
