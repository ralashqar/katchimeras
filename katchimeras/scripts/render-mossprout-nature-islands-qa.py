...
DESIGN_ROOT = ROOT / "design" / "mossprout-nature-islands-v1"
OUTPUT_ROOT = ROOT / "artifacts" / "mossprout-nature-islands-v1"
...
def main() -> None:
    ...
    print(world_path.relative_to(ROOT))
    print(comparison_path.relative_to(ROOT))
    print(thumbnail_path.relative_to(ROOT))
