...
check('place quest metadata requires location', parkQuest.requiresCapabilities.includes('location.foreground'));
check('place quest metadata includes travel memory assist', parkQuest.optionalCapabilities.includes('location.background'));
