...
const layoutSource = fs.readFileSync(path.join(projectRoot, 'utils/daily-card-layout.ts'), 'utf8');
const viewerSource = fs.readFileSync(path.join(projectRoot, 'components/katchadeck/cards/daily-card-viewer.tsx'), 'utf8');
const frameSource = fs.readFileSync(path.join(projectRoot, 'components/katchadeck/cards/daily-card-back-frame.tsx'), 'utf8');
