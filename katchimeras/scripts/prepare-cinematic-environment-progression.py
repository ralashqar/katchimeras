...
DESIGN_ROOT = ROOT / "design" / "exploration-backgrounds" / "progressions"
RUNTIME_ROOT = ROOT / "assets" / "images" / "katchimeras" / "world" / "backgrounds"
...
def main() -> None:
    ...
    for stage in manifest["stages"]:
        ...
        for size in runtime_sizes:
            ...
            print(f"WROTE {output.relative_to(ROOT)} ({size}px)")
