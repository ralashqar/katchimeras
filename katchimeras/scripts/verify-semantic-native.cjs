...
const swiftPath = path.join(root, 'modules', 'katchimera-semantic', 'ios', 'KatchimeraSemanticModule.swift');
const configPath = path.join(root, 'modules', 'katchimera-semantic', 'expo-module.config.json');
