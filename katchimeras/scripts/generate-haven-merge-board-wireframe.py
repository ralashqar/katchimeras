...
OUTPUT = ROOT / "artifacts" / "haven-merge-board-structure-only-6x7.png"
GRIDLESS_OUTPUT = ROOT / "artifacts" / "haven-merge-board-structure-only-gridless.png"
SIZE = 1254
...
def main() -> None:
    ...
    print(f"Generated {GRIDLESS_OUTPUT.relative_to(ROOT)} ({SIZE}x{SIZE})")
