...
SOURCE = ROOT / "artifacts" / "haven-merge-board-reference-direct-6x7-alpha-no-despill.png"
OUTPUT = ROOT / "artifacts" / "haven-merge-board-perspective-guide.png"
...
def main() -> None:
    ...
    print(f"Generated {OUTPUT.relative_to(ROOT)} ({guide.width}x{guide.height})")
