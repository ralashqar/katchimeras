...
export const dayPromptRegistry: Record<DayPromptKind, DayPromptDefinition> = {
  feeling: {
    ...
    launchEnabled: true,
    options: [
      { id: 'calm', label: 'Calm', emoji: 'Calm', icon: 'moon.stars.fill', semanticTags: ['feeling:calm'], scoreBias: { calm: 0.34 } },
      { id: 'good', label: 'Good', emoji: 'Good', icon: 'sun.max.fill', semanticTags: ['feeling:good'], scoreBias: { calm: 0.12, energy: 0.08 } },
      { id: 'energized', label: 'Energized', emoji: 'Energy', icon: 'bolt.fill', semanticTags: ['feeling:energized'], scoreBias: { energy: 0.34 } },
      {
        id: 'loved',
        label: 'Loved',
        emoji: 'Loved',
      ...
      { id: 'meh', label: 'Meh', emoji: 'Meh', icon: 'cloud.fill', semanticTags: ['feeling:meh'], scoreBias: { calm: 0.08 } },
      { id: 'drained', label: 'Drained', emoji: 'Drained', icon: 'cloud.rain.fill', semanticTags: ['feeling:drained', 'body:tired'], scoreBias: { calm: 0.2 } },
      { id: 'low', label: 'Low', emoji: 'Low', icon: 'cloud.fog.fill', semanticTags: ['feeling:low', 'tender_day'], scoreBias: { calm: 0.18 }, encounterSeedBias: [{ seedId: 'tender_day', intensity: 0.34 }] },
      { id: 'stressed', label: 'Stressed', emoji: 'Stress', icon: 'cloud.bolt.rain.fill', semanticTags: ['feeling:stressed', 'restless_day'], scoreBias: { focus: 0.12, energy: 0.08 } },
    ],
  },
  sleep: {
    id: 'sleep',
