...
export const GROWTH_ENERGY_ART = require('@/assets/images/katchimeras/today-icons/growth-energy-v2.webp');
...
export const TODAY_CARE_ART = {
  ...
  voice: require('@/assets/images/katchimeras/world/props/artefact_voice_crystal.png'),
  ...
  quest: require('@/assets/images/katchimeras/today-icons/quests.png'),
