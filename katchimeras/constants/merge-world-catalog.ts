...
export const MERGE_GENERATORS: readonly MergeGeneratorDefinition[] = [
  { id: 'starter-pantry', familyId: 'food', name: 'Shared Pantry', icon: 'fork.knife', color: '#C97847', initialCell: 31, baseBranches: ['table'] },
  { id: 'nature-pot', familyId: 'nature', name: 'Mossprout’s Pot', icon: 'leaf.fill', color: '#5E9E69', initialCell: 38, baseBranches: ['garden'] },
  { id: 'adventure-pack', familyId: 'adventure', name: 'Steppling’s Pack', icon: 'figure.walk', color: '#967044', initialCell: 32, baseBranches: ['trail'] },
];
...
export const MERGE_ORDER_TEMPLATES: readonly MergeOrderTemplate[] = [
  ...
  { key: 'first-feast', characterId: 'feastle', title: 'Feastle’s First Feast', difficulty: 'major', requirements: [{ definitionId: 'food:table:5', quantity: 1 }], reward: { coins: 130, mergeXp: 110, friendshipXp: 70, energy: 12, wispId: 'crumb' }, signature: true },
