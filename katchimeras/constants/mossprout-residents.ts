...
export const MOSSPROUT_RESIDENTS: readonly MossproutResidentDefinition[] = [
  { id: 'mossprout', requestThemes: ['garden', 'waterside', 'keepsake'], requestCopy: [
  ...
  { id: 'petalimp', requestThemes: ['garden'], requestCopy: [
  ...
  { id: 'fernip', requestThemes: ['garden', 'keepsake'], requestCopy: [
  ...
  { id: 'blossle', requestThemes: ['garden'], requestCopy: [
  ...
  { id: 'amberleaf', requestThemes: ['garden', 'keepsake'], requestCopy: [
  ...
  { id: 'drizzlet', requestThemes: ['waterside'], requestCopy: [
  ...
  { id: 'mistle', requestThemes: ['waterside', 'keepsake'], requestCopy: [
  ...
  { id: 'driftkin', requestThemes: ['waterside', 'garden'], requestCopy: [
  ...
  { id: 'tempesto', requestThemes: ['garden', 'waterside'], requestCopy: [
