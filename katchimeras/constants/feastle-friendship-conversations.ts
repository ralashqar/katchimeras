...
const chapterOneDefinitions: readonly ConversationDefinition[] = [
  {
    ...
    nodes: [
      { id: 'arrival', kind: 'choice', phase: 'explore', prompt: 'You made it! The first snack has officially survived the Pantry. What makes a bite like this feel good?', options: [
        { id: 'easy', label: 'It was easy to reach', reply: 'A snack that arrives before hunger gets dramatic. Excellent timing.', nextNodeId: 'busy-day' },
        { id: 'comfort', label: 'It feels familiar', reply: 'Ah. The food version of a favourite blanket.', nextNodeId: 'busy-day' },
        { id: 'company', label: 'It is better shared', reply: 'Then I shall prepare two plates—and, for reasons unknown, three forks.', nextNodeId: 'busy-day' },
      ] },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'remember-enough', kind: 'memory_proposal', prompt: 'May I keep that close for the messier days?', summary: 'Easy food still counts.', memoryKey: 'feastle:ordinary-day-reminder', sensitivity: 'ordinary', nextNodeId: 'end' },
      { id: 'remember-change', kind: 'memory_proposal', prompt: 'May I keep that close for the messier days?', summary: 'Food plans are allowed to change.', memoryKey: 'feastle:ordinary-day-reminder', sensitivity: 'ordinary', nextNodeId: 'end' },
      { id: 'remember-help', kind: 'memory_proposal', prompt: 'May I keep that close for the messier days?', summary: 'Food does not always have to be managed alone.', memoryKey: 'feastle:ordinary-day-reminder', sensitivity: 'ordinary', nextNodeId: 'end' },
