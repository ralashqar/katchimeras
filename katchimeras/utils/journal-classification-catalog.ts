...
const LANGUAGE: Record<string, LanguageOverride> = {
  ...
  'movement.errands': { examples: ['I ran errands', 'I went shopping'], aliases: ['shopping'] },
  ...
  'work.home_tasks': { examples: ['I did chores around the house', 'I fixed something at home'], aliases: ['chores', 'housework', 'home maintenance'] },
  ...
  'general.morning': { examples: ['I took my time getting started this morning', 'I watched the morning light'], aliases: ['morning routine', 'morning'] },
  'general.nature': { examples: ['I noticed blossom on my street', 'The storm changed the feeling of the day'], aliases: ['weather', 'nature', 'season'] },
