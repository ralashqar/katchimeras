...
REFERENCE = ROOT / "assets/images/katchimeras/world/backgrounds/home/home-exploration-v1.png"
OUTPUT = ROOT / "assets/images/katchimeras/today-icons"
WORK = ROOT / "tmp/today-growth-energy-v2"
...
def main() -> None:
    ...
    manifest = {
        ...
        "styleReference": str(REFERENCE.relative_to(ROOT)).replace("\\", "/"),
        "prompt": PROMPT,
