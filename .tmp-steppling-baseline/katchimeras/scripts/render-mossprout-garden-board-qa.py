...
OUT_DIR = ROOT / "design/floating-neighborhood-v2/mossprout-garden-board"
CONFIG = json.loads((ROOT / "constants/kingdom-world-view.json").read_text(encoding="utf-8"))
...
def paste_mossprout(canvas: Image.Image) -> None:
    image = Image.open(ROOT / "assets/images/katchimeras/cutouts/mossprout.png").convert("RGBA")
