...
export const onboardingShowcaseAssets = {
  onboarding_run_voltstep: {
    ...
    source: require('../assets/images/onboarding-showcase/voltstep.webp'),
    sourceImageUrl:
  ...
  onboarding_home_hearthsip: {
    ...
    source: require('../assets/images/onboarding-showcase/hearthsip.webp'),
    sourceImageUrl:
  ...
  onboarding_museum_glimmuse: {
    ...
    source: require('../assets/images/onboarding-showcase/glimmuse.webp'),
    sourceImageUrl:
  ...
  onboarding_landmark_skysette: {
    ...
    source: require('../assets/images/onboarding-showcase/skysette.webp'),
    sourceImageUrl:
  ...
  onboarding_today_cremalume: {
    ...
    source: require('../assets/images/onboarding-showcase/creamalume.webp'),
    sourceImageUrl:
