...
export function createContentFlowCompiler({ validateStoryNodeCapability, isRegisteredStoryRoute, validateDefinition }: {
validateStoryNodeCapability: (node: Exclude<ContentFlowNode, {kind: 'branch' | 'complete'}>) => string | null;
isRegisteredStoryRoute: (target: import('./types').StoryRouteTarget) => boolean;
validateDefinition?: (definition: ContentFlowDefinition) => ContentFlowValidationIssue[];
}) {
...
function validateContentFlowDefinition(definition: ContentFlowDefinition): ContentFlowValidationIssue[] {
...
function defineContentFlow<T extends ContentFlowDefinition>(definition: T): T {
...
return { validateContentFlowDefinition, defineContentFlow };
}
