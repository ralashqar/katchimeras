...
import { isAppForeground, useAppForeground } from '@incubator/presentation/app-foreground';
import { createPendingVisualCompletion } from '@incubator/presentation/pending-visual-completion';
...
} from './hex-camera-math';
import { HAVEN_UPGRADE_REDUCED_TIMING, HAVEN_UPGRADE_TIMING } from './upgrade-presentation';
